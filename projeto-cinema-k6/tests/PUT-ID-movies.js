...
import { getMovies, createMovie, deleteMovie, testConfig, updateMovieById } from '../support/utils/apiRequests.js';
import { htmlReport } from "https://raw.githubusercontent.com/benc-uk/k6-reporter/main/dist/bundle.js";

// HTML
export function handleSummary(data) {
    return {
      "PUT-ID-movies-enduranceTest.html": htmlReport(data),
    };
}
export const options = testConfig.options.enduranceTest;
...
export default () => {
  ...
  const moviesRes = getMovies(); // Obter filmes para atualizar
